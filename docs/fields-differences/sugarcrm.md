...
|---------------------|----------------------|---------------------|----------|-----------------|----------------------|--------------------------|------------------|
|  | account_id | string |  |  | accounts | account_id | str |
...
|  | assigned_user_id | string |  |  | users | assigned_user_id | str |
|  | base_rate | string |  |  |  | base_rate | str |
|  | best_case | string |  |  |  | best_case | str |
|  | campaign_id | string |  |  |  | campaign_id | str |
|  | campaign_opportunities | object |  |  |  | campaign_opportunities | object |
...
|  | created_by | string |  |  | users | created_by | str |
|  | currency_id | string |  | `US Dollars`, `Euro` |  | currency_id | str |
...
|  | team_name | array |  |  |  | team_name | array |
...
|  |  |  |  |  |  | dri_workflow_template_link | object |
...
|  | <span style='color:red'>***teams***</span> | array |  |  |  |  |  |
|  | <span style='color:red'>***teams[]***</span> | object |  |  |  |  |  |
|  | <span style='color:red'>***teams[].id***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***teams[].name***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***teams[].name_2***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***teams[].primary***</span> | boolean |  |  |  |  |  |
|  | <span style='color:red'>***teams[].selected***</span> | boolean |  |  |  |  |  |
|  |  |  |  |  |  | _acl | object |
|  |  |  |  |  |  | _acl.fields | object |
|  |  |  |  |  |  | _module | str |
|  |  |  |  |  |  | assigned_user_link | object |
...
|  | my_favorite | boolean |  |  |  | my_favorite | bool |
|  | name | string |  |  |  | name | str |
|  | opportunities | object |  |  |  | opportunities | object |
...
|  | reports_to_id | string |  |  | users | reports_to_id | str |
...
|  | twitter | string |  |  |  | twitter | str |
|  | <span style='color:red'>***team***</span> | array |  |  |  |  |  |
|  | <span style='color:red'>***team[]***</span> | object |  |  |  |  |  |
|  | <span style='color:red'>***team[].id***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***team[].name***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***team[].name_2***</span> | string |  |  |  |  |  |
|  | <span style='color:red'>***team[].primary***</span> | boolean |  |  |  |  |  |
|  | <span style='color:red'>***team[].selected***</span> | boolean |  |  |  |  |  |
|  |  |  |  |  |  | _acl | object |
|  |  |  |  |  |  | _acl.fields | object |
|  |  |  |  |  |  | _module | str |
