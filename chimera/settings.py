...
MIDDLEWARE = [
    ...
    "chimera.gong_middleware.AllowFromGongMiddleware",
]
...
IPAAS_WORKSPACE_TOKEN_EXPIRATION_SECONDS = int(
...
INTEGRATION_CONFIGS_DIR = os.environ.get("INTEGRATION_CONFIGS_DIR", APPS_DIR / "connectors" / "connector_definitions")
